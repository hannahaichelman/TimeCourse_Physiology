...
#make pco2 and temperature factors
...
levels(calcdata$treatment) <- c("358uatm, 28°C","325uatm, 31°C","471uatm, 28°C","424uatm, 31°C","674uatm, 28°C","606uatm, 31°C","2750uatm, 28°C","2917uatm, 31°C")
...
#SSID null model
m0 <- lmer(Growthmg.cm2.day ~ 1 + (1|gen_rz), data=calcdataSid)
summary(m0)
AIC(m0)
#[1] 388.5082

#test adding parameters and check AIC
m1 <- lmer(Growthmg.cm2.day ~ pco2 + time + time*pco2 + (1|gen_rz), data=calcdataSid)
summary(m1)
anova(m1)
AIC(m1)
#[1] 334.1994 - pco2 + (1|gen_rz)
#[1] 324.6796 - pco2 + time + (1|gen_rz)
#[1] 324.4376 - pco2 + time + time*pco2 + (1|gen_rz)
...
m1 <- lmer(Growthmg.cm2.day ~ time*temp*pco2*rz + (1|gen_rz), data=calcdataSid)
...
levels(physdata$time) <- c("T0", "T30", "T60", "T90")
...
#SSID null model
m0 <- lmer(zoox_cm2 ~ 1 + (1|gen_rz), data=sidzoox)
summary(m0)
AIC(m0)
#[1] 4253.196

#test adding parameters and check AIC
m1 <- lmer(zoox_cm2 ~ time+temp+pco2 + time:pco2 + (1|gen_rz), data=sidzoox)
summary(m1)
anova(m1)
AIC(m1)
#[1] 4160.866 - time + (1|gen_rz)
#[1] 4130.832 - time + temp + (1|gen_rz)
#[1] 4074.359 - time + temp + pco2 + (1|gen_rz)
#[1] 3894.342 - time+temp+pco2 + time:pco2 + (1|gen_rz)
...
lsmeans(m1, pairwise~time*pco2, adjust="tukey")

#PSTR null model
m0 <- lmer(zoox_cm2 ~ 1 + (1|gen_rz), data=dipzoox)
summary(m0)
AIC(m0)
#[1] 3584.918

#test adding parameters and check AIC
m1 <- lmer(zoox_cm2 ~ temp + time + (1|gen_rz), data=dipzoox)
summary(m1)
anova(m1)
AIC(m1)
#[1] 3542.754 - temp + (1|gen_rz)
#[1] 3447.407 - time + temp + (1|gen_rz)
...
#SSID null model  
m0 <- lmer(chlA_ug_cm2 ~ 1 + (1|gen_rz), data=sidchl)
summary(m0)
AIC(m0)
#[1] 843.1642

#test adding parameters and check AIC
m1 <- lmer(chlA_ug_cm2 ~ time + pco2 + (1|gen_rz), data=sidchl)
summary(m1)
anova(m1)
AIC(m1)
#[1] 762.7609 - time + (1|gen_rz)
#[1] 751.3589 - time + pco2 + (1|gen_rz)
...
#PSTR null model
m0 <- lmer(chlA_ug_cm2 ~ 1 + (1|gen_rz), data=dipchl)
summary(m0)
AIC(m0)
#[1] 783.0019

#test adding parameters and check AIC
m1 <- lmer(chlA_ug_cm2 ~ temp + pco2 + (1|gen_rz), data=dipchl)
summary(m1)
anova(m1)
AIC(m1)
#[1] 752.7033 - temp + (1|gen_rz)
#[1] 744.8378 - temp + pco2 + (1|gen_rz)
...
#post-hoc tests for significant parameters
lsmeans(m1, pairwise~time*temp, adjust="tukey")
...
#SSID null model 
m0 <- lmer(carbs_mg_mL ~ 1 + (1|gen_rz), data=sidcarb)
summary(m0)
AIC(m0)
#[1] 539.8806

#test adding parameters and check AIC
m1 <- lmer(carbs_mg_mL ~ temp + (1|gen_rz), data=sidcarb)
summary(m1)
anova(m1)
AIC(m1)
#[1] 533.6716 - temp + (1|gen_rz)

#post hoc tests
lsmeans(m1, pairwise~temp, adjust="tukey")

#PSTR null model
m0 <- lmer(carbs_mg_mL ~ 1 + (1|gen_rz), data=dipcarb)
summary(m0)
AIC(m0)
#[1] 458.5872

#test adding parameters and check AIC
m1 <- lmer(carbs_mg_mL ~ temp + time + time:temp + (1|gen_rz), data=dipcarb)
summary(m1)
anova(m1)
AIC(m1)
#[1] 439.4455 - temp + (1|gen_rz)
#[1] 431.0588 - temp + time + (1|gen_rz)
#[1] 418.9963 - temp + time + time:temp + (1|gen_rz)
