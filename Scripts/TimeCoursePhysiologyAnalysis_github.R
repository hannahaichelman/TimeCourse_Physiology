...
plot <- ggplot(time90dip, aes(x=protein,y=calcification, 
                              fill = temp, 
                              shape = pco2, 
                              color = rz)) +
  ...
  scale_shape_manual(name = "pCO2", values=c("ambient"=21, "next century"=22, "extreme"=23))+
...
plot <- ggplot(time90dip, aes(x=carbs,y=calcification, 
                              fill = temp, 
                              shape = pco2, 
                              color = rz)) +
  stat_smooth(method = "lm", col = "black", aes(group=temp))+
...
plot <- ggplot(time90dip, aes(x=syms,y=calcification, 
                              fill = temp, 
                              shape = pco2, 
                              color = rz)) +
  stat_smooth(method = "lm", col = "black", aes(group=temp))+
...
plot <- ggplot(time90dip, aes(x=Chla,y=calcification, 
                              fill = temp, 
                              shape = pco2, 
                              color = rz)) +
  stat_smooth(method = "lm", col = "black", aes(group=temp))+
