...
levels(physdata$treatment) <- c("298uatm, 28.0°C","325uatm, 31°C","471uatm, 28°C","388uatm, 31.1°C","663uatm, 28.0°C","662uatm, 31.0°C","2973uatm, 28.1°C","3245uatm, 30.7°C")
...
plot1 <- ggplot(time90dip, aes(x=protein,y=calcification, 
                              fill = temp, 
                              shape = pco2, 
                              color = rz)) +
  ...
  scale_shape_manual(name = "pCO2", values=c("ambient"=21, "next century"=24, "extreme"=22))+
  scale_color_manual(name = "Reef Zone", values=c("slategray4","black"))+
  #facet_wrap(temp~.)+
  theme_cowplot()
plot1
ggsave(file="~/Documents/BU/NEU_experiment/Regression_Analysis/by_treatment/PSTR/PSTR_calc_prot_bytemp+rz+pco2_T90_nofacet.pdf", plot, width=5, height=5, units=c("in"), useDingbats=FALSE)
...
plot2 <- ggplot(time90dip, aes(x=carbs,y=calcification, 
                              fill = temp, 
                              shape = pco2, 
                              color = rz)) +
  stat_smooth(method = "lm", col = "black", aes(group=temp))+
  ...
  theme_cowplot()
plot2
ggsave(file="~/Documents/BU/NEU_experiment/Regression_Analysis/by_treatment/PSTR/PSTR_calc_carb_T90_bytemp+rz+pco2_nofacet.pdf", plot, width=5, height=5, units=c("in"), useDingbats=FALSE)
...
plot3 <- ggplot(time90dip, aes(x=syms,y=calcification, 
                              fill = temp, 
                              shape = pco2, 
                              color = rz)) +
  stat_smooth(method = "lm", col = "black", aes(group=temp))+
  ...
  theme_cowplot()
plot3
ggsave(file="~/Documents/BU/NEU_experiment/Regression_Analysis/by_treatment/PSTR/PSTR_calc_syms_bytemp+rz+pco2_T90_nofacet.pdf", plot, width=5, height=5, units=c("in"), useDingbats=FALSE)
...
plot4 <- ggplot(time90dip, aes(x=Chla,y=calcification, 
                              fill = temp, 
                              shape = pco2, 
                              color = rz)) +
  stat_smooth(method = "lm", col = "black", aes(group=temp))+
  ...
  theme_cowplot()
plot4
ggsave(file="~/Documents/BU/NEU_experiment/Regression_Analysis/by_treatment/PSTR/PSTR_calc_chla_bytemp+rz+pco2_T90_nofacet.pdf", plot, width=5, height=5, units=c("in"), useDingbats=FALSE)
...
# arrange linear regression figures
library(gridExtra)
fig6_combined <- grid.arrange(plot2, plot1, plot3, plot4, nrow = 2)
ggsave(file="~/Documents/BU/NEU_experiment/Regression_Analysis/by_treatment/PSTR/PSTR_calc_chla_bytemp+rz+pco2_T90_new.pdf", fig6_combined, width=10, height=10, units=c("in"), useDingbats=FALSE)
